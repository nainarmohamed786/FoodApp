    ...
    return (
        <ScrollView>
            <SafeAreaView>
                ...
                <Pressable style={{ backgroundColor: "red", paddingHorizontal: 10, paddingVertical: 25 }} onPress={() => router.push({
                    pathname: "/(home)",
                })}>
                    <Text style={{ color: "white", fontSize: 15, textAlign: "center" }}>Back to Home</Text>
                </Pressable>
            </SafeAreaView>
        </ScrollView>
